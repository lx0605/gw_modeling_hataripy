...
def mflist_export(f, mfl, **kwargs):
    ...
    if isinstance(f, str) and f.lower().endswith(".shp"):
        ...
        if model_grid is None:
            ...
            raise Exception('hataripy does not support exporting to shapefile '
...
def export_contours(modelgrid, filename, contours,
    ...
    **kwargs : key-word arguments to hataripy.export.shapefile_utils.recarray2shp
    ...
    """
    from hataripy.utils.geometry import LineString
    from hataripy.export.shapefile_utils import recarray2shp
